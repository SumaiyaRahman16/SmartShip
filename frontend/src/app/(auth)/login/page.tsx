      ...
      <div className="relative z-10 w-full max-w-sm rounded-[var(--radius-lg)] p-8 flex flex-col gap-5
        ...
        <div className="flex justify-center">
          <div className="flex items-center justify-center">
            ...
            <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/successful-delivery.png" alt="successful-delivery" />          </div>
        </div>

        {/* Heading */}
        <div className="text-center">
          <h1 className="text-lg font-semibold text-text-main">Welcome back!!!!</h1>
          <p className="text-xs text-text-main/40 mt-1">Sign in to access SmartShip.</p>
        </div>
        ...
        {/* <div className="flex gap-3">
          {(["google", "facebook", "apple"] as const).map((provider) => (
            ...
            >
              ...
              {provider === "apple" && (
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#dde2d2">
